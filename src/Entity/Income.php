...
class Income
{
    ...
    #[ORM\Column]
    private ?\DateTimeImmutable $income_created_at = null;
    ...
    public function getIncomeCreatedAt(): ?\DateTimeImmutable
    {
        return $this->income_created_at;
    }

    public function setIncomeCreatedAt(\DateTimeImmutable $income_created_at): static
    {
        $this->income_created_at = $income_created_at;
